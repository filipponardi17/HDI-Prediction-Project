...
variables_to_keep <- c("js_hom", "age", "dut_ill", "js_abr", "js_div", "imp_rlg", "js_euth", "ps_arm", "el_fair", "el_brb", "ps_lead",
                   "job_men", "trs_ntn", "dmc_coup", "c_chr", "el_thr", "dmc_obey", "dut_chl", "hom_prn", "dmc_cnt", "dmc_rlg", "trs_knw",
                   "c_gvr", "c_plc", "c_prt", "HDI")
...
```{r}
in_train <- createDataPartition(scaled_df$HDI, p = 0.75, list = FALSE)  # 75% for training
