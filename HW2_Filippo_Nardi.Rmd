...
# numeric_vars_to_scale <- sapply(imputed_data, is.numeric)
# 
# numeric_vars_to_scale["HDI"] <- FALSE
# 
# scaled_df <- imputed_data
# 
# scaled_df[, numeric_vars_to_scale] <- scale(scaled_df[, numeric_vars_to_scale])


# I will be using Random Forest feature importance to obtain the first 30 (out of the 117 I have) variables to predict HDI:
